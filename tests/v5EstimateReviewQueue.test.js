...
test('UI connects submission and review actions',()=>{for(const text of ['submit_v5_estimate_for_review','read_v5_estimate_review_queue','Review submissions','Promote to Official Draft','Return for Changes'])assert.match(route,new RegExp(text));});
