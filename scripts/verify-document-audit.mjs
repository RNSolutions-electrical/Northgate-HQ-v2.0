...
try{
 ...
 for(const owner of ['job','estimate'])for(const [width,height] of [[1440,1000],[768,1024],[390,844]]){
  ...
  assert.equal(saved.args.p_reason,null);
 ...
 console.log('PASS: Jobs/Estimates edit and restore, reason-free save failure preservation, archive cancel/retry, metadata upload cleanup, no duplicate client audits, desktop/tablet/phone.');
