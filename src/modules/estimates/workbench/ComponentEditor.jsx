   ...
   {group.lines.map((line,index)=>{
    ...
    return <section className={'component-resource '+(bad?'resource-missing':'')} key={line.id} data-line-id={line.id}>
     ...
     <div className="resource-fields">
      ...
      <Numeric label="Unit cost" value={line.price} disabled={!editable||labor} onChange={price=>change(line.id,{price,priceOverride:true,priceSource:'estimate_override',priceSourceUpdatedAt:null,priceSnapshotAt:new Date().toISOString()})}/>
