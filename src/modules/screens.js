...
import {AfcWorkspace} from './afc/AfcWorkspace.jsx';
import { DashboardWorkspace } from './dashboard/DashboardWorkspace.jsx';
...
import { EstimatesWorkspace } from './estimates/EstimatesWorkspace.jsx';
...
import { PanelDirectoryWorkspace } from './panel-directory/PanelDirectoryWorkspace.jsx';
...
export const MODULE_SCREENS = {
  ...
  estimates: EstimatesWorkspace,
  inventory: InventoryWorkspace,
  jobs: JobsWorkspace,
  reports: ReportsWorkspace,
  'panel-directory': PanelDirectoryWorkspace,
