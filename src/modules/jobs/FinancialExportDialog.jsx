...
import { buildFinancialExportRows, downloadFinancialFile, filterFinancialExportRows, FINANCIAL_EXPORT_OPTIONS, financialExportCsv, financialExportDivisions, financialExportPdf } from './jobFinancialExport.mjs';
...
export function FinancialExportDialog({ open, onClose, job, lines, changeOrderByLineId }) {
 ...
 async function exportFile(format){
  ...
  try{
   ...
   else downloadFinancialFile(await financialExportPdf({job,rows:exportRows,selected}),filename+'.pdf','application/pdf');
