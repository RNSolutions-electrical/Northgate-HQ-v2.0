...
export const UI_TERMINOLOGY = Object.freeze([
  ...
  { type: 'FUNCTION', name: 'Edit Storage Location', location: 'Material Inventory › Locations & QR', status: 'ready for testing' },
  { type: 'FUNCTION', name: 'Archive Storage Location', location: 'Material Inventory › Locations & QR', status: 'ready for testing' },
