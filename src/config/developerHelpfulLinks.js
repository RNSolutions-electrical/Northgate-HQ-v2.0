...
export const DEVELOPER_HELPFUL_LINKS = [
  {
    id: 'supabase',
    title: 'Supabase - Northgate HQ v2',
  ...
  },
  {
    ...
    instructions: [
      'Open the Northgate HQ v2 site and confirm the production deploy corresponds to the expected GitHub commit.',
      'Check Deploy Logs when production differs from a successful local build.',
      'Verify the build command remains npm run build and the publish directory remains dist.',
